package photos.vbstudio.login.network;
...
import photos.vbstudio.login.fragments.BaseForTabbedFragment;
import photos.vbstudio.login.fragments.BaseFragment;
import photos.vbstudio.login.utils.NetworkUtils;
...
public class NetworkManager implements RequestQueue.RequestFilter {
    ...
    public Request<?> jsonPOSTFormDataRequest(Context context, Object requestListener, String subUrl, final Map<String, String> params, Listener<String> listener, ErrorListener errorListener, RetryPolicy defaultRetryPolicy, boolean shouldCache) {

        StringRequest request = new StringRequest(Request.Method.POST, BASE_URL + subUrl, listener, errorListener) {
    ...
    public Request<?> jsonRequest(Context context, Request request, JSONObject params, Class<?> requestTag, RetryPolicy defaultRetryPolicy, boolean shouldCache) {
    ...
    public static void handleErrorResponse(Context context, VolleyError error) {
        ...
        int textColorId = R.color.accent_color;
        ...
        if (error instanceof TimeoutError) {
            ...
            textColorId = R.color.light_toolbar_color;
